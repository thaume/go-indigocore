...
var (
	...
	dbDir           = flag.String("db_dir", config.GetString("db_dir"), "Database dir.")
	...
	profLaddr       = flag.String("prof_laddr", config.GetString("prof_laddr"), "Profile listen addres.")
	csWalFile       = flag.String("cs_wal_file", config.GetString("cs_wal_file"), "Consensus state store dir")
	...
	disableDataHash = flag.Bool("disable_data_hash", config.GetBool("disable_data_hash"), "Disable Merkle-izing block txs")
